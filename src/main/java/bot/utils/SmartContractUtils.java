...
public class SmartContractUtils {
    ...
    public static double getGLPPrice(Web3j web3j) throws InterruptedException, ExecutionException {
        ...
        Function function = new Function("getPrice", // Function name
                Collections.singletonList(new Bool(true)), 
                outputs); // Function returned parameters

        String encodedFunction = FunctionEncoder.encode(function);
        EthCall encodedResponse = web3j.ethCall(
                Transaction.createEthCallTransaction(AccConstant.GOD_KEY, GMXConstant.GLP_MANAGER_ADDRESS, encodedFunction),
    ...
    public static void getPositions(Web3j web3j)
    ...
    private static double convertToUsd(BigInteger price, int decimals) {
